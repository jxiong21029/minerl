...
class DataPipelineWithReward:
    ...
    def __init__(
        ...
        self.data_queue = self.m.Queue(
            maxsize=self.size_to_dequeue // self.worker_batch_size * 4
        )
    ...
    def batch_iter(self, batch_size):
        ...
        load_data_func = self._get_load_data_func(
            self.data_queue,
            self.nsteps,
                    ...
                    if not ret or frame_num >= len(univ):
                        ...
                        try:
                            ...
                            if frames_queue.full():
                                next_obs = [
                                    o.from_universal(frame) for o in observables
                                ]
                                ...
                                batches.append(
                                    (
                                        ...
                                        mission,
                                        next_obs,
                                        DataPipelineWithReward._calculate_discount_rew(
                                            rewards[-nsteps:], gamma
                                        ),
                                        frame_num + 1 - nsteps,
                                    )
                                )
